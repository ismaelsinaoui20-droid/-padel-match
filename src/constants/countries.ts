// Liste des pays du monde (noms français), triée alphabétiquement à l'usage.
const RAW_COUNTRIES = [
  ...
  'République dominicaine', 'République démocratique du Congo', 'République tchèque',
...
export const COUNTRIES: string[] = [...RAW_COUNTRIES].sort((a, b) => a.localeCompare(b, 'fr'));
